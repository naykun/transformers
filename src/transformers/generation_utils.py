...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        self, input_ids: Optional[torch.LongTensor] = None, input_embeds: Optional[torch.FloatTensor] = None, model_kwargs = None
    ) -> Dict[str, Any]:
        ...
        if input_embeds is not None:
            model_kwargs["encoder_outputs"]: ModelOutput = encoder(inputs_embeds=input_embeds, return_dict=True, **encoder_kwargs)
        else:
            model_kwargs["encoder_outputs"]: ModelOutput = encoder(input_ids, return_dict=True, **encoder_kwargs)
        return model_kwargs

    def _prepare_decoder_input_ids_for_generation(
        self, input_ids: torch.LongTensor, input_embeds:Optional[torch.FloatTensor], decoder_start_token_id: int = None, bos_token_id: int = None, **model_kwargs
    ) -> torch.LongTensor:
    ...
    def generate(
        ...
        **model_kwargs
        ...
        if self.config.is_encoder_decoder:
            ...
            model_kwargs = self._prepare_encoder_decoder_kwargs_for_generation(input_ids, input_embeds, model_kwargs)

            # set input_ids as decoder_input_ids
            input_ids = self._prepare_decoder_input_ids_for_generation(
                input_ids, input_embeds, decoder_start_token_id=decoder_start_token_id, bos_token_id=bos_token_id, **model_kwargs
            )
